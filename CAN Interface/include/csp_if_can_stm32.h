...
/**
   ...
   Used by csp_can_tx_stm32() to send CAN frames.
...
/**
   ...
   @return #CSP_ERR_NONE on success, otherwise an error code.
*/
int csp_can_rx_stm32(csp_iface_t * iface, uint32_t id, const uint8_t * data, uint8_t dlc, CSP_BASE_TYPE *pxTaskWoken);
